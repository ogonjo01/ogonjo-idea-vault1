          ...
          <Card>
            <CardContent>
              ...
              <div>
                ...
                <p className="section-text">
                  Your information helps us operate and improve our free service. We use it to:
                </p>
                <ul className="list">
                  <li className="list-item">Provide and maintain the platform.</li>
                  <li className="list-item">Analyze usage patterns to improve the quality and relevance of our book summaries.</li>
                  <li className="list-item">Personalize your experience (e.g., suggesting new books you might like).</li>
                  <li className="list-item">Communicate with you regarding service updates or other important information.</li>
                </ul>
                <p className="section-text">
                  We will never sell your personal data. We may use anonymized, aggregated data for research or analytics to better understand our audience and content performance.
                </p>
              </div>
